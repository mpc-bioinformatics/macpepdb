...
class FastaReader(FileReader):
    ...
    # There are also two TrypperDB specific attributes "TDBPI" the proteome id and "TDBPM" old protein accessions which are merged with this proteins.
    ...
    # Protein id (TrypperDB-specific): Contain only numbers "\d+"
